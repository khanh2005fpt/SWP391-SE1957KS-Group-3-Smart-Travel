  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
       <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Trang chủ <i class="fa fa-chevron-right"></i></a></span> <span>Giới thiệu <i class="fa fa-chevron-right"></i></span></p>
    ...
    <div class="row d-flex">
      <div class="col-md-6 order-md-last heading-section pl-md-5 ftco-animate d-flex align-items-center">
       <div class="w-100">
        ...
        <p>Một con sông nhỏ tên là Duden chảy qua nơi của họ và cung cấp những điều cần thiết. Đó là một đất nước thiên đường, nơi những phần câu nướng bay vào miệng bạn.</p>
        <p>Xa xa, sau những ngọn núi chữ, xa các quốc gia Vokalia và Consonantia, có những văn bản mù sinh sống. Họ sống tách biệt ở Bookmarksgrove ngay bên bờ biển của Semantics, một đại dương ngôn ngữ rộng lớn.
        Một con sông nhỏ tên là Duden chảy qua nơi của họ và cung cấp những điều cần thiết.</p>
      ...
      <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
        <div class="services services-1 color-1 d-block img" style="background-image: url(images/services-1.jpg);">
          ...
          <div class="media-body">
            ...
            <p>Một con sông nhỏ tên là Duden chảy qua nơi của họ và cung cấp những điều cần thiết</p>
          </div>
        </div>      
      </div>
      <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
    ...
    <div class="col-md-6 pl-md-5 py-5">
      <div class="row justify-content-start pb-3">
        <div class="col-md-12 heading-section ftco-animate">
         ...
         <p>Xa xa, sau những ngọn núi chữ, xa các quốc gia Vokalia và Consonantia, có những văn bản mù sinh sống. Họ sống tách biệt ở Bookmarksgrove ngay bên bờ biển của Semantics, một đại dương ngôn ngữ rộng lớn.</p>
